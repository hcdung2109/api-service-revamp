...
namespace Digisource\Calendars\Providers;

use Digisource\Calendars\Providers\RouteServiceProvider;
use Digisource\Core\Providers\BaseServiceProvider;
use Illuminate\Support\Arr;
use Illuminate\Support\Facades\Blade;

class CalendarsServiceProvider extends BaseServiceProvider
{
    protected $path_config = 'Config/config.php';
    protected $moduleName = 'Calendars';
    protected string $moduleNameLower = 'calendars';
