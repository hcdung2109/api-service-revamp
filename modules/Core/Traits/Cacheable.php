...
trait Cacheable
{
    ...
    {
        $this->module = Str::lower($this->module);
        $keysFile = $this->getContainer('config')->get($this->module.'.repository.cache.keys_file');
    ...
    protected function flushCacheKeys(): array
    {
        ...
        $this->module = Str::lower($this->module);
        $config = $this->getContainer('config')->get($this->module.'.repository.cache');
    ...
    public function getCacheLifetime(): int
    {
        ...
        $this->module = Str::lower($this->module);
        return $this->cacheLifetime ?? $this->getContainer('config')->get($this->module.'.repository.cache.lifetime');
    }
