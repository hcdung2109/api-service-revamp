...
//
//        $router->get('/company-commissions', 'CompanyController@get_company_commissions');
//        $router->post('/company-commissions', 'CompanyController@create_company_commissions');
//        $router->post('/company-commissions/:uuid', 'CompanyController@update_company_commissions');
//        $router->get('/company-commissions/:uuid', 'CompanyController@get_company_commissions_by_id');
//        $router->delete('/company-commissions/:uuid', 'CompanyController@delete_company_commissions');
//
//        $router->get('/notes', 'CompanyController@get_company_notes');
//        $router->post('/notes', 'CompanyController@create_company_notes');
//        $router->post('/notes/:uuid', 'CompanyController@update_company_notes');
//        $router->get('/notes/:uuid', 'CompanyController@get_job_company_by_id');
//        $router->delete('/notes/:uuid', 'CompanyController@delete_company_notes');
//
...
//        $router->get('/job-categories', 'SettingsJobController@get_job_category');
//
//        $router->get('/job-group', 'JobController@get_job_group');
//        $router->post('/job-group', 'JobController@create_job_group');
//        $router->post('/job-group/:uuid', 'JobController@update_job_group');
//        $router->get('/job-group/:uuid', 'JobController@get_job_group_by_id');
//        $router->delete('/job-group/:uuid', 'JobController@delete_job_group');
//
//        $router->get('/job-group-permission', 'JobController@get_job_group_permission');
//        $router->post('/job-group-permission', 'JobController@create_job_group_permission');
//        $router->post('/job-group-permission/:uuid', 'JobController@update_job_group_permission');
//        $router->get('/job-group-permission/:uuid', 'JobController@get_job_group_permission_by_id');
//        $router->delete('/job-group-permission/:uuid', 'JobController@delete_job_group_permission');
//
//        $router->get('/skills', 'JobController@get_job_skills');
//        $router->post('/skills', 'JobController@create_job_skills');
//        $router->post('/skills/:uuid', 'JobController@update_job_skills');
//        $router->get('/skills/:uuid', 'JobController@get_job_skills_by_id');
//        $router->delete('/skills/:uuid', 'JobController@delete_job_skills');
//
//        $router->get('/notes', 'JobController@get_job_notes');
//        $router->post('/notes', 'JobController@create_job_notes');
//        $router->post('/notes/:uuid', 'JobController@update_job_notes');
//        $router->get('/notes/:uuid', 'JobController@get_job_notes_by_id');
//        $router->delete('/notes/:uuid', 'JobController@delete_job_notes');
//
//        $router->get('/job-stages', 'JobController@get_job_stages');
//        $router->post('/job-stages', 'JobController@create_job_stages');
//        $router->post('/job-stages/:uuid', 'JobController@update_job_stages');
//        $router->get('/job-stages/:uuid', 'JobController@get_job_stages_by_id');
//        $router->delete('/job-stages/:uuid', 'JobController@delete_job_stages');
//
...
//
//        $router->get('/job-commission', 'JobController@get_job_commissions');
//        $router->post('/job-commission', 'JobController@create_job_commissions');
//        $router->post('/job-commission/:uuid', 'JobController@update_job_commissions');
//        $router->get('/job-commission/:uuid', 'JobController@get_job_commissions_by_id');
//        $router->delete('/job-commission/:uuid', 'JobController@delete_job_commissions');
//
