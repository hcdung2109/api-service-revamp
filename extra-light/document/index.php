	...
	if (file_exists($local_file) && is_file($local_file)) {
		...
		if ($width != "" || $height != "") {
			...
			if (file_exists($file_resize)) {
				...
				//$img = $appSession->getTool()->resize_image($local_file, $width, $height);
			
				$local_file = $file_resize;
			}
		}
		
		$file = fopen($local_file, "rwxrwxrwx");
...
?>
	...
	<script>
		...
		?>
				...
				<?php echo ($i + 1); ?>.<?php echo $name; ?> <?php if ($can_edit == "1") { ?> < a href = "javascript:updateName<?php echo $pageIndex; ?>('<?php echo $file_id; ?>', '<?php echo $name; ?>');" > < i class = "icon-pencil" > < /i></a > & nbsp; & nbsp; < a href = "<?php echo URL; ?>document/?id=<?php echo $file_id; ?>"
				target = "_blank" > < i class = "icon-cloud-download" > < /i> </a > & nbsp; & nbsp; < a href = "javascript:delDoc<?php echo $pageIndex; ?>('<?php echo $file_id; ?>')" > < i class = "icon-close" > < /i></a > <?php } ?>
			<?php
			} else {
			?>
				<?php echo ($i + 1); ?>.<?php echo $name; ?> & nbsp; & nbsp;
				<?php if ($can_edit == "1") { ?> < a href = "javascript:updateName<?php echo $pageIndex; ?>('<?php echo $file_id; ?>', '<?php echo $name; ?>');" > < i class = "icon-pencil" > < /i></a > & nbsp; & nbsp; < a href = "<?php echo URL; ?>document/?ac=download&id=<?php echo $file_id; ?>"
					target = "_blank" > < i class = "icon-cloud-download" > < /i></a > & nbsp; & nbsp; < a href = "javascript:delDoc<?php echo $pageIndex; ?>('<?php echo $file_id; ?>')" > < i class = "icon-close" > < /i></a > <?php } ?>
